...
export interface NotificationClientFilterOptions {
  page?: number;
  limit?: number;
  search?: string;
  sortBy?: string;
...
export class NotificationClient {
  ...
  private readonly basePath: string = '/api/v1/notifications';
  ...
  public async list<T = any>(options?: NotificationClientFilterOptions): Promise<{ items: T[]; total: number; page: number; limit: number }> {
