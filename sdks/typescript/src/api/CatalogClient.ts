...
export interface CatalogClientFilterOptions {
  page?: number;
  limit?: number;
  search?: string;
  sortBy?: string;
...
export class CatalogClient {
  ...
  private readonly basePath: string = '/api/v1/catalog';
  ...
  public async list<T = any>(options?: CatalogClientFilterOptions): Promise<{ items: T[]; total: number; page: number; limit: number }> {
