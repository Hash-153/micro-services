...
export interface InventoryClientFilterOptions {
  page?: number;
  limit?: number;
  search?: string;
  sortBy?: string;
...
export class InventoryClient {
  ...
  private readonly basePath: string = '/api/v1/inventory';
  ...
  public async list<T = any>(options?: InventoryClientFilterOptions): Promise<{ items: T[]; total: number; page: number; limit: number }> {
