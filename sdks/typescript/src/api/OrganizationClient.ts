...
export interface OrganizationClientFilterOptions {
  page?: number;
  limit?: number;
  search?: string;
  sortBy?: string;
...
export class OrganizationClient {
  ...
  private readonly basePath: string = '/api/v1/organizations';
  ...
  public async list<T = any>(options?: OrganizationClientFilterOptions): Promise<{ items: T[]; total: number; page: number; limit: number }> {
