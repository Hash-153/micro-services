...
export interface ReviewClientFilterOptions {
  page?: number;
  limit?: number;
  search?: string;
  sortBy?: string;
...
export class ReviewClient {
  ...
  private readonly basePath: string = '/api/v1/reviews';
  ...
  public async list<T = any>(options?: ReviewClientFilterOptions): Promise<{ items: T[]; total: number; page: number; limit: number }> {
