...
export interface PaymentClientFilterOptions {
  page?: number;
  limit?: number;
  search?: string;
  sortBy?: string;
...
export class PaymentClient {
  ...
  private readonly basePath: string = '/api/v1/payments';
  ...
  public async list<T = any>(options?: PaymentClientFilterOptions): Promise<{ items: T[]; total: number; page: number; limit: number }> {
