...
class RecommendationClientFilterOptions(BaseModel):
    page: int = 1
    limit: int = 20
...
class RecommendationClient:
    """Collaborative filtering and product affinity graphs"""
    def __init__(self, http_client: httpx.AsyncClient, base_url: str):
        self.http_client = http_client
        self.base_url = base_url.rstrip('/') + "/api/v1/recommendations"
