...
class CatalogServiceModelV6Payload(BaseModel):
...
class CatalogServiceModelV6Filter(BaseModel):
    tenant_id: str
...
class CatalogServiceModelV6ListResponse(BaseModel):
    items: List[CatalogServiceModelV6Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
