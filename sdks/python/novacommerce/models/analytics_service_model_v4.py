...
class AnalyticsServiceModelV4Payload(BaseModel):
...
class AnalyticsServiceModelV4Filter(BaseModel):
    tenant_id: str
...
class AnalyticsServiceModelV4ListResponse(BaseModel):
    items: List[AnalyticsServiceModelV4Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
