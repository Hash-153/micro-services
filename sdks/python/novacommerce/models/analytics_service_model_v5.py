...
class AnalyticsServiceModelV5Payload(BaseModel):
...
class AnalyticsServiceModelV5Filter(BaseModel):
    tenant_id: str
...
class AnalyticsServiceModelV5ListResponse(BaseModel):
    items: List[AnalyticsServiceModelV5Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
