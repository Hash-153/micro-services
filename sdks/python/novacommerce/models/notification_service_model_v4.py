...
class NotificationServiceModelV4Payload(BaseModel):
...
class NotificationServiceModelV4Filter(BaseModel):
    tenant_id: str
...
class NotificationServiceModelV4ListResponse(BaseModel):
    items: List[NotificationServiceModelV4Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
