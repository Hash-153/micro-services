...
class AuthServiceModelV5Payload(BaseModel):
...
class AuthServiceModelV5Filter(BaseModel):
    tenant_id: str
...
class AuthServiceModelV5ListResponse(BaseModel):
    items: List[AuthServiceModelV5Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
