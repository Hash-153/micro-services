...
class AnalyticsServiceModelV6Payload(BaseModel):
...
class AnalyticsServiceModelV6Filter(BaseModel):
    tenant_id: str
...
class AnalyticsServiceModelV6ListResponse(BaseModel):
    items: List[AnalyticsServiceModelV6Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
