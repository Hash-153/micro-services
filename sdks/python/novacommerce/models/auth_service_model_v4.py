...
class AuthServiceModelV4Payload(BaseModel):
...
class AuthServiceModelV4Filter(BaseModel):
    tenant_id: str
...
class AuthServiceModelV4ListResponse(BaseModel):
    items: List[AuthServiceModelV4Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
