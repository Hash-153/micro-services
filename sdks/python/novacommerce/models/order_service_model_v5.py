...
class OrderServiceModelV5Payload(BaseModel):
...
class OrderServiceModelV5Filter(BaseModel):
    tenant_id: str
...
class OrderServiceModelV5ListResponse(BaseModel):
    items: List[OrderServiceModelV5Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
