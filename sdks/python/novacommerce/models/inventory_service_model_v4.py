...
class InventoryServiceModelV4Payload(BaseModel):
...
class InventoryServiceModelV4Filter(BaseModel):
    tenant_id: str
...
class InventoryServiceModelV4ListResponse(BaseModel):
    items: List[InventoryServiceModelV4Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
