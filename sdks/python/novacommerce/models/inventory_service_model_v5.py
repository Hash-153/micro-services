...
class InventoryServiceModelV5Payload(BaseModel):
...
class InventoryServiceModelV5Filter(BaseModel):
    tenant_id: str
...
class InventoryServiceModelV5ListResponse(BaseModel):
    items: List[InventoryServiceModelV5Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
