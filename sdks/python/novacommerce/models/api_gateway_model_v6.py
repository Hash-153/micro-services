...
class ApiGatewayModelV6Payload(BaseModel):
...
class ApiGatewayModelV6Filter(BaseModel):
    tenant_id: str
...
class ApiGatewayModelV6ListResponse(BaseModel):
    items: List[ApiGatewayModelV6Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
