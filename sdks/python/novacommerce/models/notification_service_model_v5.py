...
class NotificationServiceModelV5Payload(BaseModel):
...
class NotificationServiceModelV5Filter(BaseModel):
    tenant_id: str
...
class NotificationServiceModelV5ListResponse(BaseModel):
    items: List[NotificationServiceModelV5Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
