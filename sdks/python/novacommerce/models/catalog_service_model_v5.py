...
class CatalogServiceModelV5Payload(BaseModel):
...
class CatalogServiceModelV5Filter(BaseModel):
    tenant_id: str
...
class CatalogServiceModelV5ListResponse(BaseModel):
    items: List[CatalogServiceModelV5Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
