...
class PaymentServiceModelV4Payload(BaseModel):
...
class PaymentServiceModelV4Filter(BaseModel):
    tenant_id: str
...
class PaymentServiceModelV4ListResponse(BaseModel):
    items: List[PaymentServiceModelV4Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
