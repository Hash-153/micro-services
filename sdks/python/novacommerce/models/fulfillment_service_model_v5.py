...
class FulfillmentServiceModelV5Payload(BaseModel):
...
class FulfillmentServiceModelV5Filter(BaseModel):
    tenant_id: str
...
class FulfillmentServiceModelV5ListResponse(BaseModel):
    items: List[FulfillmentServiceModelV5Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
