...
class UserServiceModelV5Payload(BaseModel):
...
class UserServiceModelV5Filter(BaseModel):
    tenant_id: str
...
class UserServiceModelV5ListResponse(BaseModel):
    items: List[UserServiceModelV5Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
