...
class UserServiceModelV6Payload(BaseModel):
...
class UserServiceModelV6Filter(BaseModel):
    tenant_id: str
...
class UserServiceModelV6ListResponse(BaseModel):
    items: List[UserServiceModelV6Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
