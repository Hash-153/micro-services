...
class OrderServiceModelV4Payload(BaseModel):
...
class OrderServiceModelV4Filter(BaseModel):
    tenant_id: str
...
class OrderServiceModelV4ListResponse(BaseModel):
    items: List[OrderServiceModelV4Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
