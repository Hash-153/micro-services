...
class FulfillmentServiceModelV4Payload(BaseModel):
...
class FulfillmentServiceModelV4Filter(BaseModel):
    tenant_id: str
...
class FulfillmentServiceModelV4ListResponse(BaseModel):
    items: List[FulfillmentServiceModelV4Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
