...
class UserServiceModelV4Payload(BaseModel):
...
class UserServiceModelV4Filter(BaseModel):
    tenant_id: str
...
class UserServiceModelV4ListResponse(BaseModel):
    items: List[UserServiceModelV4Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
