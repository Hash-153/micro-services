...
class PaymentServiceModelV5Payload(BaseModel):
...
class PaymentServiceModelV5Filter(BaseModel):
    tenant_id: str
...
class PaymentServiceModelV5ListResponse(BaseModel):
    items: List[PaymentServiceModelV5Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
