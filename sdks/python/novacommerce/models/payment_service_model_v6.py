...
class PaymentServiceModelV6Payload(BaseModel):
...
class PaymentServiceModelV6Filter(BaseModel):
    tenant_id: str
...
class PaymentServiceModelV6ListResponse(BaseModel):
    items: List[PaymentServiceModelV6Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
