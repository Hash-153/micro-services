...
class InventoryServiceModelV6Payload(BaseModel):
...
class InventoryServiceModelV6Filter(BaseModel):
    tenant_id: str
...
class InventoryServiceModelV6ListResponse(BaseModel):
    items: List[InventoryServiceModelV6Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
