...
class FulfillmentServiceModelV6Payload(BaseModel):
...
class FulfillmentServiceModelV6Filter(BaseModel):
    tenant_id: str
...
class FulfillmentServiceModelV6ListResponse(BaseModel):
    items: List[FulfillmentServiceModelV6Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
