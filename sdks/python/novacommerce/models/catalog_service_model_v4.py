...
class CatalogServiceModelV4Payload(BaseModel):
...
class CatalogServiceModelV4Filter(BaseModel):
    tenant_id: str
...
class CatalogServiceModelV4ListResponse(BaseModel):
    items: List[CatalogServiceModelV4Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
