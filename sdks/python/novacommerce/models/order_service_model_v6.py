...
class OrderServiceModelV6Payload(BaseModel):
...
class OrderServiceModelV6Filter(BaseModel):
    tenant_id: str
...
class OrderServiceModelV6ListResponse(BaseModel):
    items: List[OrderServiceModelV6Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
