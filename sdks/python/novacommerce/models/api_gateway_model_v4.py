...
class ApiGatewayModelV4Payload(BaseModel):
...
class ApiGatewayModelV4Filter(BaseModel):
    tenant_id: str
...
class ApiGatewayModelV4ListResponse(BaseModel):
    items: List[ApiGatewayModelV4Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
