...
class AuthServiceModelV6Payload(BaseModel):
...
class AuthServiceModelV6Filter(BaseModel):
    tenant_id: str
...
class AuthServiceModelV6ListResponse(BaseModel):
    items: List[AuthServiceModelV6Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
