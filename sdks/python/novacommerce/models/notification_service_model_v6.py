...
class NotificationServiceModelV6Payload(BaseModel):
...
class NotificationServiceModelV6Filter(BaseModel):
    tenant_id: str
...
class NotificationServiceModelV6ListResponse(BaseModel):
    items: List[NotificationServiceModelV6Payload]
    total_count: int
    limit: int
    offset: int
    has_more: bool
