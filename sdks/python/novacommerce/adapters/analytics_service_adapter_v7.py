...
class AnalyticsServiceAsyncAdapterV7Config(BaseModel):
...
class AnalyticsServiceAsyncAdapterV7:
    """High-performance async adapter for analytics-service version 7"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[AnalyticsServiceAsyncAdapterV7Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v7/analytics"
        self.config = config or AnalyticsServiceAsyncAdapterV7Config()
