...
class AnalyticsServiceAsyncAdapterV9Config(BaseModel):
...
class AnalyticsServiceAsyncAdapterV9:
    """High-performance async adapter for analytics-service version 9"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[AnalyticsServiceAsyncAdapterV9Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v9/analytics"
        self.config = config or AnalyticsServiceAsyncAdapterV9Config()
