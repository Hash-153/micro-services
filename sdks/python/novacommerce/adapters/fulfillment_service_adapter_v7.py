...
class FulfillmentServiceAsyncAdapterV7Config(BaseModel):
...
class FulfillmentServiceAsyncAdapterV7:
    """High-performance async adapter for fulfillment-service version 7"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[FulfillmentServiceAsyncAdapterV7Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v7/fulfillment"
        self.config = config or FulfillmentServiceAsyncAdapterV7Config()
