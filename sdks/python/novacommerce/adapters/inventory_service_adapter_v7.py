...
class InventoryServiceAsyncAdapterV7Config(BaseModel):
...
class InventoryServiceAsyncAdapterV7:
    """High-performance async adapter for inventory-service version 7"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[InventoryServiceAsyncAdapterV7Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v7/inventory"
        self.config = config or InventoryServiceAsyncAdapterV7Config()
