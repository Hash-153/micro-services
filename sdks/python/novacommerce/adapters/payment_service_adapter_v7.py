...
class PaymentServiceAsyncAdapterV7Config(BaseModel):
...
class PaymentServiceAsyncAdapterV7:
    """High-performance async adapter for payment-service version 7"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[PaymentServiceAsyncAdapterV7Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v7/payment"
        self.config = config or PaymentServiceAsyncAdapterV7Config()
