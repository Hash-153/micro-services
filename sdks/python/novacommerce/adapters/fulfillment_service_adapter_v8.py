...
class FulfillmentServiceAsyncAdapterV8Config(BaseModel):
...
class FulfillmentServiceAsyncAdapterV8:
    """High-performance async adapter for fulfillment-service version 8"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[FulfillmentServiceAsyncAdapterV8Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v8/fulfillment"
        self.config = config or FulfillmentServiceAsyncAdapterV8Config()
