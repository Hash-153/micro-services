...
class ApiGatewayAsyncAdapterV7Config(BaseModel):
...
class ApiGatewayAsyncAdapterV7:
    """High-performance async adapter for api-gateway version 7"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[ApiGatewayAsyncAdapterV7Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v7/api-gateway"
        self.config = config or ApiGatewayAsyncAdapterV7Config()
