...
class UserServiceAsyncAdapterV8Config(BaseModel):
...
class UserServiceAsyncAdapterV8:
    """High-performance async adapter for user-service version 8"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[UserServiceAsyncAdapterV8Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v8/user"
        self.config = config or UserServiceAsyncAdapterV8Config()
