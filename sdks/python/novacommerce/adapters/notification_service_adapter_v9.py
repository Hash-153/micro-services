...
class NotificationServiceAsyncAdapterV9Config(BaseModel):
...
class NotificationServiceAsyncAdapterV9:
    """High-performance async adapter for notification-service version 9"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[NotificationServiceAsyncAdapterV9Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v9/notification"
        self.config = config or NotificationServiceAsyncAdapterV9Config()
