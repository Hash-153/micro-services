...
class CatalogServiceAsyncAdapterV7Config(BaseModel):
...
class CatalogServiceAsyncAdapterV7:
    """High-performance async adapter for catalog-service version 7"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[CatalogServiceAsyncAdapterV7Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v7/catalog"
        self.config = config or CatalogServiceAsyncAdapterV7Config()
