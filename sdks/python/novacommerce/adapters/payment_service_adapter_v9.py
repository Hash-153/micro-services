...
class PaymentServiceAsyncAdapterV9Config(BaseModel):
...
class PaymentServiceAsyncAdapterV9:
    """High-performance async adapter for payment-service version 9"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[PaymentServiceAsyncAdapterV9Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v9/payment"
        self.config = config or PaymentServiceAsyncAdapterV9Config()
