...
class ApiGatewayAsyncAdapterV8Config(BaseModel):
...
class ApiGatewayAsyncAdapterV8:
    """High-performance async adapter for api-gateway version 8"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[ApiGatewayAsyncAdapterV8Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v8/api-gateway"
        self.config = config or ApiGatewayAsyncAdapterV8Config()
