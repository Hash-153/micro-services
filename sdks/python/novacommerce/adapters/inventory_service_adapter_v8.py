...
class InventoryServiceAsyncAdapterV8Config(BaseModel):
...
class InventoryServiceAsyncAdapterV8:
    """High-performance async adapter for inventory-service version 8"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[InventoryServiceAsyncAdapterV8Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v8/inventory"
        self.config = config or InventoryServiceAsyncAdapterV8Config()
