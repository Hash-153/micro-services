...
class CatalogServiceAsyncAdapterV8Config(BaseModel):
...
class CatalogServiceAsyncAdapterV8:
    """High-performance async adapter for catalog-service version 8"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[CatalogServiceAsyncAdapterV8Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v8/catalog"
        self.config = config or CatalogServiceAsyncAdapterV8Config()
