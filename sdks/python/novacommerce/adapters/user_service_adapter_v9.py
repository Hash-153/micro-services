...
class UserServiceAsyncAdapterV9Config(BaseModel):
...
class UserServiceAsyncAdapterV9:
    """High-performance async adapter for user-service version 9"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[UserServiceAsyncAdapterV9Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v9/user"
        self.config = config or UserServiceAsyncAdapterV9Config()
