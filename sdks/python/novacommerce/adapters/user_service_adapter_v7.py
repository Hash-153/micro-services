...
class UserServiceAsyncAdapterV7Config(BaseModel):
...
class UserServiceAsyncAdapterV7:
    """High-performance async adapter for user-service version 7"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[UserServiceAsyncAdapterV7Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v7/user"
        self.config = config or UserServiceAsyncAdapterV7Config()
