...
class PaymentServiceAsyncAdapterV8Config(BaseModel):
...
class PaymentServiceAsyncAdapterV8:
    """High-performance async adapter for payment-service version 8"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[PaymentServiceAsyncAdapterV8Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v8/payment"
        self.config = config or PaymentServiceAsyncAdapterV8Config()
