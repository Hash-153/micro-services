...
class NotificationServiceAsyncAdapterV8Config(BaseModel):
...
class NotificationServiceAsyncAdapterV8:
    """High-performance async adapter for notification-service version 8"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[NotificationServiceAsyncAdapterV8Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v8/notification"
        self.config = config or NotificationServiceAsyncAdapterV8Config()
