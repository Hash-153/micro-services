...
class ApiGatewayAsyncAdapterV9Config(BaseModel):
...
class ApiGatewayAsyncAdapterV9:
    """High-performance async adapter for api-gateway version 9"""
    def __init__(self, client: httpx.AsyncClient, base_url: str, config: Optional[ApiGatewayAsyncAdapterV9Config] = None):
        self.client = client
        self.base_url = base_url.rstrip('/') + "/api/v9/api-gateway"
        self.config = config or ApiGatewayAsyncAdapterV9Config()
