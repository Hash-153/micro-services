export interface RateQuotaTierV12 {
...
export const RATE_QUOTA_TIERS_V12: Record<string, RateQuotaTierV12> = {
...
export class NotificationServiceRateLimitingPolicyV12 {
  public static getQuota(tier: keyof typeof RATE_QUOTA_TIERS_V12): RateQuotaTierV12 {
    return RATE_QUOTA_TIERS_V12[tier] || RATE_QUOTA_TIERS_V12.STANDARD_USER;
  }

  public static isAllowed(currentMinuteCount: number, tier: keyof typeof RATE_QUOTA_TIERS_V12): { allowed: boolean; remaining: number; resetSeconds: number } {
