export interface InfinibandSwitchSpecConfig {
  specId: string;
  categorySlug: 'infiniband-switch';
  categoryName: 'NDR 400Gbps InfiniBand Switches';
...
export const INFINIBAND_SWITCH_DEFAULT_SPEC: InfinibandSwitchSpecConfig = {
  specId: 'spec_infiniband-switch_v1',
  categorySlug: 'infiniband-switch',
  categoryName: 'NDR 400Gbps InfiniBand Switches',
  hardwareDomain: 'Networking',
...
export class InfinibandSwitchSpecValidator {
  public static validate(config: InfinibandSwitchSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: InfinibandSwitchSpecConfig = INFINIBAND_SWITCH_DEFAULT_SPEC): number {
