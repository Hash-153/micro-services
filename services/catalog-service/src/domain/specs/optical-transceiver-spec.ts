export interface OpticalTransceiverSpecConfig {
  specId: string;
  categorySlug: 'optical-transceiver';
  categoryName: '800G OSFP Optical Transceivers';
...
export const OPTICAL_TRANSCEIVER_DEFAULT_SPEC: OpticalTransceiverSpecConfig = {
  specId: 'spec_optical-transceiver_v1',
  categorySlug: 'optical-transceiver',
  categoryName: '800G OSFP Optical Transceivers',
  hardwareDomain: 'Networking',
...
export class OpticalTransceiverSpecValidator {
  public static validate(config: OpticalTransceiverSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: OpticalTransceiverSpecConfig = OPTICAL_TRANSCEIVER_DEFAULT_SPEC): number {
