export interface PowerBusbarSpecConfig {
  specId: string;
  categorySlug: 'power-busbar';
  categoryName: 'Solid Copper Overhead DC Power Busway Rails';
...
export const POWER_BUSBAR_DEFAULT_SPEC: PowerBusbarSpecConfig = {
  specId: 'spec_power-busbar_v1',
  categorySlug: 'power-busbar',
  categoryName: 'Solid Copper Overhead DC Power Busway Rails',
  hardwareDomain: 'Power',
...
export class PowerBusbarSpecValidator {
  public static validate(config: PowerBusbarSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: PowerBusbarSpecConfig = POWER_BUSBAR_DEFAULT_SPEC): number {
