export interface SanDirectorSpecConfig {
  specId: string;
  categorySlug: 'san-director';
  categoryName: 'Gen 7 64G Fibre Channel Director Switches';
...
export const SAN_DIRECTOR_DEFAULT_SPEC: SanDirectorSpecConfig = {
  specId: 'spec_san-director_v1',
  categorySlug: 'san-director',
  categoryName: 'Gen 7 64G Fibre Channel Director Switches',
  hardwareDomain: 'Storage',
...
export class SanDirectorSpecValidator {
  public static validate(config: SanDirectorSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: SanDirectorSpecConfig = SAN_DIRECTOR_DEFAULT_SPEC): number {
