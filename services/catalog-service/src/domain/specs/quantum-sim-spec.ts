export interface QuantumSimSpecConfig {
  specId: string;
  categorySlug: 'quantum-sim';
  categoryName: 'Quantum Simulation Accelerators';
...
export const QUANTUM_SIM_DEFAULT_SPEC: QuantumSimSpecConfig = {
  specId: 'spec_quantum-sim_v1',
  categorySlug: 'quantum-sim',
  categoryName: 'Quantum Simulation Accelerators',
  hardwareDomain: 'Quantum',
...
export class QuantumSimSpecValidator {
  public static validate(config: QuantumSimSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: QuantumSimSpecConfig = QUANTUM_SIM_DEFAULT_SPEC): number {
