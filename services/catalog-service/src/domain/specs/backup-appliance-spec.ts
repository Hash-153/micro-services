export interface BackupApplianceSpecConfig {
  specId: string;
  categorySlug: 'backup-appliance';
  categoryName: 'Deduplicating Enterprise Backup Storage Appliances';
...
export const BACKUP_APPLIANCE_DEFAULT_SPEC: BackupApplianceSpecConfig = {
  specId: 'spec_backup-appliance_v1',
  categorySlug: 'backup-appliance',
  categoryName: 'Deduplicating Enterprise Backup Storage Appliances',
  hardwareDomain: 'Storage',
...
export class BackupApplianceSpecValidator {
  public static validate(config: BackupApplianceSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: BackupApplianceSpecConfig = BACKUP_APPLIANCE_DEFAULT_SPEC): number {
