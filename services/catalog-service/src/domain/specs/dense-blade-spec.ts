export interface DenseBladeSpecConfig {
  specId: string;
  categorySlug: 'dense-blade';
  categoryName: 'High-Density 8-Node MicroCloud Server Blades';
...
export const DENSE_BLADE_DEFAULT_SPEC: DenseBladeSpecConfig = {
  specId: 'spec_dense-blade_v1',
  categorySlug: 'dense-blade',
  categoryName: 'High-Density 8-Node MicroCloud Server Blades',
  hardwareDomain: 'Compute',
...
export class DenseBladeSpecValidator {
  public static validate(config: DenseBladeSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: DenseBladeSpecConfig = DENSE_BLADE_DEFAULT_SPEC): number {
