export interface SmartnicDpuSpecConfig {
  specId: string;
  categorySlug: 'smartnic-dpu';
  categoryName: 'Data Processing Units (DPU / SmartNIC)';
...
export const SMARTNIC_DPU_DEFAULT_SPEC: SmartnicDpuSpecConfig = {
  specId: 'spec_smartnic-dpu_v1',
  categorySlug: 'smartnic-dpu',
  categoryName: 'Data Processing Units (DPU / SmartNIC)',
  hardwareDomain: 'Compute',
...
export class SmartnicDpuSpecValidator {
  public static validate(config: SmartnicDpuSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: SmartnicDpuSpecConfig = SMARTNIC_DPU_DEFAULT_SPEC): number {
