export interface LtoTapeDriveSpecConfig {
  specId: string;
  categorySlug: 'lto-tape-drive';
  categoryName: 'LTO-9 Enterprise Tape Automation Libraries';
...
export const LTO_TAPE_DRIVE_DEFAULT_SPEC: LtoTapeDriveSpecConfig = {
  specId: 'spec_lto-tape-drive_v1',
  categorySlug: 'lto-tape-drive',
  categoryName: 'LTO-9 Enterprise Tape Automation Libraries',
  hardwareDomain: 'Storage',
...
export class LtoTapeDriveSpecValidator {
  public static validate(config: LtoTapeDriveSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: LtoTapeDriveSpecConfig = LTO_TAPE_DRIVE_DEFAULT_SPEC): number {
