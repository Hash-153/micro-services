export interface DieselGeneratorCtrlSpecConfig {
  specId: string;
  categorySlug: 'diesel-generator-ctrl';
  categoryName: 'Synchronizing Emergency Diesel Genset Controllers';
...
export const DIESEL_GENERATOR_CTRL_DEFAULT_SPEC: DieselGeneratorCtrlSpecConfig = {
  specId: 'spec_diesel-generator-ctrl_v1',
  categorySlug: 'diesel-generator-ctrl',
  categoryName: 'Synchronizing Emergency Diesel Genset Controllers',
  hardwareDomain: 'Power',
...
export class DieselGeneratorCtrlSpecValidator {
  public static validate(config: DieselGeneratorCtrlSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: DieselGeneratorCtrlSpecConfig = DIESEL_GENERATOR_CTRL_DEFAULT_SPEC): number {
