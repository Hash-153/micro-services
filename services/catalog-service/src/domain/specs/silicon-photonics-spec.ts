export interface SiliconPhotonicsSpecConfig {
  specId: string;
  categorySlug: 'silicon-photonics';
  categoryName: 'Silicon Photonics Integrated Laser Subsystems';
...
export const SILICON_PHOTONICS_DEFAULT_SPEC: SiliconPhotonicsSpecConfig = {
  specId: 'spec_silicon-photonics_v1',
  categorySlug: 'silicon-photonics',
  categoryName: 'Silicon Photonics Integrated Laser Subsystems',
  hardwareDomain: 'Networking',
...
export class SiliconPhotonicsSpecValidator {
  public static validate(config: SiliconPhotonicsSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: SiliconPhotonicsSpecConfig = SILICON_PHOTONICS_DEFAULT_SPEC): number {
