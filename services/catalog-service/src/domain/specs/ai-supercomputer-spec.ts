export interface AiSupercomputerSpecConfig {
  specId: string;
  categorySlug: 'ai-supercomputer';
  categoryName: 'Multi-Rack AI Supercomputer Pods';
...
export const AI_SUPERCOMPUTER_DEFAULT_SPEC: AiSupercomputerSpecConfig = {
  specId: 'spec_ai-supercomputer_v1',
  categorySlug: 'ai-supercomputer',
  categoryName: 'Multi-Rack AI Supercomputer Pods',
  hardwareDomain: 'Compute',
...
export class AiSupercomputerSpecValidator {
  public static validate(config: AiSupercomputerSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: AiSupercomputerSpecConfig = AI_SUPERCOMPUTER_DEFAULT_SPEC): number {
