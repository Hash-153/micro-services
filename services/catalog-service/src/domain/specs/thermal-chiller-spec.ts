export interface ThermalChillerSpecConfig {
  specId: string;
  categorySlug: 'thermal-chiller';
  categoryName: 'Adiabatic Free-Cooling Data Center Chillers';
...
export const THERMAL_CHILLER_DEFAULT_SPEC: ThermalChillerSpecConfig = {
  specId: 'spec_thermal-chiller_v1',
  categorySlug: 'thermal-chiller',
  categoryName: 'Adiabatic Free-Cooling Data Center Chillers',
  hardwareDomain: 'Infrastructure',
...
export class ThermalChillerSpecValidator {
  public static validate(config: ThermalChillerSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: ThermalChillerSpecConfig = THERMAL_CHILLER_DEFAULT_SPEC): number {
