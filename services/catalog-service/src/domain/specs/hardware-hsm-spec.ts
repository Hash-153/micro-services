export interface HardwareHsmSpecConfig {
  specId: string;
  categorySlug: 'hardware-hsm';
  categoryName: 'FIPS 140-3 Level 4 Hardware Security Modules';
...
export const HARDWARE_HSM_DEFAULT_SPEC: HardwareHsmSpecConfig = {
  specId: 'spec_hardware-hsm_v1',
  categorySlug: 'hardware-hsm',
  categoryName: 'FIPS 140-3 Level 4 Hardware Security Modules',
  hardwareDomain: 'Security',
...
export class HardwareHsmSpecValidator {
  public static validate(config: HardwareHsmSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: HardwareHsmSpecConfig = HARDWARE_HSM_DEFAULT_SPEC): number {
