export interface EdgeMicroDcSpecConfig {
  specId: string;
  categorySlug: 'edge-micro-dc';
  categoryName: 'Self-Contained All-in-One Edge Micro Data Centers';
...
export const EDGE_MICRO_DC_DEFAULT_SPEC: EdgeMicroDcSpecConfig = {
  specId: 'spec_edge-micro-dc_v1',
  categorySlug: 'edge-micro-dc',
  categoryName: 'Self-Contained All-in-One Edge Micro Data Centers',
  hardwareDomain: 'Infrastructure',
...
export class EdgeMicroDcSpecValidator {
  public static validate(config: EdgeMicroDcSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: EdgeMicroDcSpecConfig = EDGE_MICRO_DC_DEFAULT_SPEC): number {
