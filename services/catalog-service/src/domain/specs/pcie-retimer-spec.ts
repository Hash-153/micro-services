export interface PcieRetimerSpecConfig {
  specId: string;
  categorySlug: 'pcie-retimer';
  categoryName: 'PCIe Gen 5.0 Low-Latency Active Retimer Cards';
...
export const PCIE_RETIMER_DEFAULT_SPEC: PcieRetimerSpecConfig = {
  specId: 'spec_pcie-retimer_v1',
  categorySlug: 'pcie-retimer',
  categoryName: 'PCIe Gen 5.0 Low-Latency Active Retimer Cards',
  hardwareDomain: 'Compute',
...
export class PcieRetimerSpecValidator {
  public static validate(config: PcieRetimerSpecConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static getDeratingCurve(ambientTempCelsius: number, config: PcieRetimerSpecConfig = PCIE_RETIMER_DEFAULT_SPEC): number {
