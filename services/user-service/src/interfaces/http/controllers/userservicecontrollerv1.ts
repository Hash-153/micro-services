...
import { UserServiceRepositoryV1 } from '../repositories/userservicerepositoryv1.js';

export class UserServiceControllerV1 {
  private repo: UserServiceRepositoryV1;
  private logger: Logger;

  constructor(repo: UserServiceRepositoryV1, logger: Logger) {
    this.repo = repo;
    this.logger = logger;
  }
  ...
  public async getById(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in UserServiceControllerV1.getById:`, err);
  ...
  public async listByTenant(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in UserServiceControllerV1.listByTenant:`, err);
      return res.status(500).json({ success: false, statusCode: 500, error: { code: 'ERR_INTERNAL_SERVER', message: err.message } });
    }
  }
  ...
  public async create(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in UserServiceControllerV1.create:`, err);
      return res.status(500).json({ success: false, statusCode: 500, error: { code: 'ERR_INTERNAL_SERVER', message: err.message } });
    }
  }
}
