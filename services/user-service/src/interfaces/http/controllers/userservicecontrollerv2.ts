...
import { UserServiceRepositoryV2 } from '../repositories/userservicerepositoryv2.js';

export class UserServiceControllerV2 {
  private repo: UserServiceRepositoryV2;
  private logger: Logger;

  constructor(repo: UserServiceRepositoryV2, logger: Logger) {
    this.repo = repo;
    this.logger = logger;
  }
  ...
  public async getById(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in UserServiceControllerV2.getById:`, err);
  ...
  public async listByTenant(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in UserServiceControllerV2.listByTenant:`, err);
      return res.status(500).json({ success: false, statusCode: 500, error: { code: 'ERR_INTERNAL_SERVER', message: err.message } });
    }
  }
  ...
  public async create(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in UserServiceControllerV2.create:`, err);
      return res.status(500).json({ success: false, statusCode: 500, error: { code: 'ERR_INTERNAL_SERVER', message: err.message } });
    }
  }
}
