...
export interface FedexInternationalRateEngineProfile {
...
export const FEDEX_INTERNATIONAL_PROFILE: FedexInternationalRateEngineProfile = {
  carrierCode: 'fedex-international',
  carrierName: 'FedEx International Priority',
  serviceType: 'INTERNATIONAL_AIR',
...
export class FedexInternationalRateEngine {
  private profile: FedexInternationalRateEngineProfile;

  constructor(profile: FedexInternationalRateEngineProfile = FEDEX_INTERNATIONAL_PROFILE) {
