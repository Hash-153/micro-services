...
export interface UpsWorldwideRateEngineProfile {
  carrierCode: 'ups-worldwide';
...
export const UPS_WORLDWIDE_PROFILE: UpsWorldwideRateEngineProfile = {
  carrierCode: 'ups-worldwide',
  carrierName: 'UPS Worldwide Express',
  serviceType: 'INTERNATIONAL_AIR',
...
export class UpsWorldwideRateEngine {
  private profile: UpsWorldwideRateEngineProfile;

  constructor(profile: UpsWorldwideRateEngineProfile = UPS_WORLDWIDE_PROFILE) {
