...
export interface DsvRoadFreightRateEngineProfile {
  carrierCode: 'dsv-road-freight';
  carrierName: 'DSV Road Heavy Haulage';
...
export const DSV_ROAD_FREIGHT_PROFILE: DsvRoadFreightRateEngineProfile = {
  carrierCode: 'dsv-road-freight',
  carrierName: 'DSV Road Heavy Haulage',
  serviceType: 'HEAVY_FREIGHT',
...
export class DsvRoadFreightRateEngine {
  private profile: DsvRoadFreightRateEngineProfile;

  constructor(profile: DsvRoadFreightRateEngineProfile = DSV_ROAD_FREIGHT_PROFILE) {
