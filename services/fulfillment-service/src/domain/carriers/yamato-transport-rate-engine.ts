...
export interface YamatoTransportRateEngineProfile {
  carrierCode: 'yamato-transport';
  carrierName: 'Yamato Transport TA-Q-BIN';
...
export const YAMATO_TRANSPORT_PROFILE: YamatoTransportRateEngineProfile = {
  carrierCode: 'yamato-transport',
  carrierName: 'Yamato Transport TA-Q-BIN',
  serviceType: 'DOMESTIC_EXPRESS',
...
export class YamatoTransportRateEngine {
  private profile: YamatoTransportRateEngineProfile;

  constructor(profile: YamatoTransportRateEngineProfile = YAMATO_TRANSPORT_PROFILE) {
