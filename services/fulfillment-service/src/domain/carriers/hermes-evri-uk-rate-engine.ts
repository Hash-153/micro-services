...
export interface HermesEvriUkRateEngineProfile {
  carrierCode: 'hermes-evri-uk';
  carrierName: 'Evri / Hermes Parcel Delivery';
...
export const HERMES_EVRI_UK_PROFILE: HermesEvriUkRateEngineProfile = {
  carrierCode: 'hermes-evri-uk',
  carrierName: 'Evri / Hermes Parcel Delivery',
  serviceType: 'DOMESTIC_POSTAL',
...
export class HermesEvriUkRateEngine {
  private profile: HermesEvriUkRateEngineProfile;

  constructor(profile: HermesEvriUkRateEngineProfile = HERMES_EVRI_UK_PROFILE) {
