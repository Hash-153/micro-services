...
export interface UspsPriorityMailRateEngineProfile {
  carrierCode: 'usps-priority-mail';
  carrierName: 'USPS Priority Mail Commercial';
  serviceType: 'DOMESTIC_GROUND';
...
export const USPS_PRIORITY_MAIL_PROFILE: UspsPriorityMailRateEngineProfile = {
  carrierCode: 'usps-priority-mail',
  carrierName: 'USPS Priority Mail Commercial',
  serviceType: 'DOMESTIC_GROUND',
...
export class UspsPriorityMailRateEngine {
  private profile: UspsPriorityMailRateEngineProfile;

  constructor(profile: UspsPriorityMailRateEngineProfile = USPS_PRIORITY_MAIL_PROFILE) {
