...
export interface KuehneNagelAirRateEngineProfile {
  carrierCode: 'kuehne-nagel-air';
  carrierName: 'Kuehne+Nagel Air Logistics';
  serviceType: 'HEAVY_AIR_FREIGHT';
...
export const KUEHNE_NAGEL_AIR_PROFILE: KuehneNagelAirRateEngineProfile = {
  carrierCode: 'kuehne-nagel-air',
  carrierName: 'Kuehne+Nagel Air Logistics',
  serviceType: 'HEAVY_AIR_FREIGHT',
  baseCostMultiplier: 4.2,
...
export class KuehneNagelAirRateEngine {
  private profile: KuehneNagelAirRateEngineProfile;

  constructor(profile: KuehneNagelAirRateEngineProfile = KUEHNE_NAGEL_AIR_PROFILE) {
