...
export interface PurolatorCanadaRateEngineProfile {
  carrierCode: 'purolator-canada';
  carrierName: 'Purolator Express Freight';
...
export const PUROLATOR_CANADA_PROFILE: PurolatorCanadaRateEngineProfile = {
  carrierCode: 'purolator-canada',
  carrierName: 'Purolator Express Freight',
  serviceType: 'DOMESTIC_EXPRESS',
...
export class PurolatorCanadaRateEngine {
  private profile: PurolatorCanadaRateEngineProfile;

  constructor(profile: PurolatorCanadaRateEngineProfile = PUROLATOR_CANADA_PROFILE) {
