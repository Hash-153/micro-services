...
export interface DpdGermanyRateEngineProfile {
  carrierCode: 'dpd-germany';
  carrierName: 'DPD Classic Germany & Europe';
  serviceType: 'EUROPE_GROUND';
...
export const DPD_GERMANY_PROFILE: DpdGermanyRateEngineProfile = {
  carrierCode: 'dpd-germany',
  carrierName: 'DPD Classic Germany & Europe',
  serviceType: 'EUROPE_GROUND',
...
export class DpdGermanyRateEngine {
  private profile: DpdGermanyRateEngineProfile;

  constructor(profile: DpdGermanyRateEngineProfile = DPD_GERMANY_PROFILE) {
