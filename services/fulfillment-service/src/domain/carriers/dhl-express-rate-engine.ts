...
export interface DhlExpressRateEngineProfile {
...
export const DHL_EXPRESS_PROFILE: DhlExpressRateEngineProfile = {
  carrierCode: 'dhl-express',
  carrierName: 'DHL Express Worldwide',
  serviceType: 'INTERNATIONAL_AIR',
...
export class DhlExpressRateEngine {
  private profile: DhlExpressRateEngineProfile;

  constructor(profile: DhlExpressRateEngineProfile = DHL_EXPRESS_PROFILE) {
