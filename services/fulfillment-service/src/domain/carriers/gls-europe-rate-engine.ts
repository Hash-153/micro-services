...
export interface GlsEuropeRateEngineProfile {
  carrierCode: 'gls-europe';
  carrierName: 'GLS EuroBusinessParcel';
...
export const GLS_EUROPE_PROFILE: GlsEuropeRateEngineProfile = {
  carrierCode: 'gls-europe',
  carrierName: 'GLS EuroBusinessParcel',
  serviceType: 'EUROPE_GROUND',
...
export class GlsEuropeRateEngine {
  private profile: GlsEuropeRateEngineProfile;

  constructor(profile: GlsEuropeRateEngineProfile = GLS_EUROPE_PROFILE) {
