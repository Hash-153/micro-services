...
export interface CorreosSpainRateEngineProfile {
  carrierCode: 'correos-spain';
  carrierName: 'Correos Paq Premium Spain';
...
export const CORREOS_SPAIN_PROFILE: CorreosSpainRateEngineProfile = {
  carrierCode: 'correos-spain',
  carrierName: 'Correos Paq Premium Spain',
  serviceType: 'DOMESTIC_POSTAL',
...
export class CorreosSpainRateEngine {
  private profile: CorreosSpainRateEngineProfile;

  constructor(profile: CorreosSpainRateEngineProfile = CORREOS_SPAIN_PROFILE) {
