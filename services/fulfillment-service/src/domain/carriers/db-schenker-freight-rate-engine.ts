...
export interface DbSchenkerFreightRateEngineProfile {
  carrierCode: 'db-schenker-freight';
  carrierName: 'DB Schenker Pallet Logistics';
...
export const DB_SCHENKER_FREIGHT_PROFILE: DbSchenkerFreightRateEngineProfile = {
  carrierCode: 'db-schenker-freight',
  carrierName: 'DB Schenker Pallet Logistics',
  serviceType: 'HEAVY_FREIGHT',
...
export class DbSchenkerFreightRateEngine {
  private profile: DbSchenkerFreightRateEngineProfile;

  constructor(profile: DbSchenkerFreightRateEngineProfile = DB_SCHENKER_FREIGHT_PROFILE) {
