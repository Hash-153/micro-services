...
export interface CanadaPostXpresspostRateEngineProfile {
  carrierCode: 'canada-post-xpresspost';
  carrierName: 'Canada Post Xpresspost';
...
export const CANADA_POST_XPRESSPOST_PROFILE: CanadaPostXpresspostRateEngineProfile = {
  carrierCode: 'canada-post-xpresspost',
  carrierName: 'Canada Post Xpresspost',
  serviceType: 'DOMESTIC_EXPRESS',
...
export class CanadaPostXpresspostRateEngine {
  private profile: CanadaPostXpresspostRateEngineProfile;

  constructor(profile: CanadaPostXpresspostRateEngineProfile = CANADA_POST_XPRESSPOST_PROFILE) {
