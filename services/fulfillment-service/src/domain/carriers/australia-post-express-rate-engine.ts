...
export interface AustraliaPostExpressRateEngineProfile {
  carrierCode: 'australia-post-express';
  carrierName: 'Australia Post Express eParcel';
...
export const AUSTRALIA_POST_EXPRESS_PROFILE: AustraliaPostExpressRateEngineProfile = {
  carrierCode: 'australia-post-express',
  carrierName: 'Australia Post Express eParcel',
  serviceType: 'DOMESTIC_EXPRESS',
...
export class AustraliaPostExpressRateEngine {
  private profile: AustraliaPostExpressRateEngineProfile;

  constructor(profile: AustraliaPostExpressRateEngineProfile = AUSTRALIA_POST_EXPRESS_PROFILE) {
