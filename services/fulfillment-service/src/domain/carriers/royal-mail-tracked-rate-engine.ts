...
export interface RoyalMailTrackedRateEngineProfile {
  carrierCode: 'royal-mail-tracked';
  carrierName: 'Royal Mail Tracked 24/48';
  serviceType: 'DOMESTIC_POSTAL';
...
export const ROYAL_MAIL_TRACKED_PROFILE: RoyalMailTrackedRateEngineProfile = {
  carrierCode: 'royal-mail-tracked',
  carrierName: 'Royal Mail Tracked 24/48',
  serviceType: 'DOMESTIC_POSTAL',
...
export class RoyalMailTrackedRateEngine {
  private profile: RoyalMailTrackedRateEngineProfile;

  constructor(profile: RoyalMailTrackedRateEngineProfile = ROYAL_MAIL_TRACKED_PROFILE) {
