...
export interface SfExpressAsiaRateEngineProfile {
  carrierCode: 'sf-express-asia';
  carrierName: 'SF Express International Air';
  serviceType: 'ASIA_PACIFIC_AIR';
...
export const SF_EXPRESS_ASIA_PROFILE: SfExpressAsiaRateEngineProfile = {
  carrierCode: 'sf-express-asia',
  carrierName: 'SF Express International Air',
  serviceType: 'ASIA_PACIFIC_AIR',
...
export class SfExpressAsiaRateEngine {
  private profile: SfExpressAsiaRateEngineProfile;

  constructor(profile: SfExpressAsiaRateEngineProfile = SF_EXPRESS_ASIA_PROFILE) {
