...
export interface SagawaExpressRateEngineProfile {
  carrierCode: 'sagawa-express';
  carrierName: 'Sagawa Express Hikyaku';
...
export const SAGAWA_EXPRESS_PROFILE: SagawaExpressRateEngineProfile = {
  carrierCode: 'sagawa-express',
  carrierName: 'Sagawa Express Hikyaku',
  serviceType: 'DOMESTIC_EXPRESS',
...
export class SagawaExpressRateEngine {
  private profile: SagawaExpressRateEngineProfile;

  constructor(profile: SagawaExpressRateEngineProfile = SAGAWA_EXPRESS_PROFILE) {
