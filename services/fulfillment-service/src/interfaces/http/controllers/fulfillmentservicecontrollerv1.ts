...
import { FulfillmentServiceRepositoryV1 } from '../repositories/fulfillmentservicerepositoryv1.js';

export class FulfillmentServiceControllerV1 {
  private repo: FulfillmentServiceRepositoryV1;
  private logger: Logger;

  constructor(repo: FulfillmentServiceRepositoryV1, logger: Logger) {
    this.repo = repo;
    this.logger = logger;
  }
  ...
  public async getById(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in FulfillmentServiceControllerV1.getById:`, err);
  ...
  public async listByTenant(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in FulfillmentServiceControllerV1.listByTenant:`, err);
      return res.status(500).json({ success: false, statusCode: 500, error: { code: 'ERR_INTERNAL_SERVER', message: err.message } });
    }
  }
  ...
  public async create(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in FulfillmentServiceControllerV1.create:`, err);
      return res.status(500).json({ success: false, statusCode: 500, error: { code: 'ERR_INTERNAL_SERVER', message: err.message } });
    }
  }
}
