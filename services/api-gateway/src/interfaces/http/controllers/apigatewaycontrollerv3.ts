...
import { ApiGatewayRepositoryV3 } from '../repositories/apigatewayrepositoryv3.js';

export class ApiGatewayControllerV3 {
  private repo: ApiGatewayRepositoryV3;
  private logger: Logger;

  constructor(repo: ApiGatewayRepositoryV3, logger: Logger) {
    this.repo = repo;
    this.logger = logger;
  }
  ...
  public async getById(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in ApiGatewayControllerV3.getById:`, err);
  ...
  public async listByTenant(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in ApiGatewayControllerV3.listByTenant:`, err);
      return res.status(500).json({ success: false, statusCode: 500, error: { code: 'ERR_INTERNAL_SERVER', message: err.message } });
    }
  }
  ...
  public async create(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in ApiGatewayControllerV3.create:`, err);
      return res.status(500).json({ success: false, statusCode: 500, error: { code: 'ERR_INTERNAL_SERVER', message: err.message } });
    }
  }
}
