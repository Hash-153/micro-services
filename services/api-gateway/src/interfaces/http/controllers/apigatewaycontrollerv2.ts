...
import { ApiGatewayRepositoryV2 } from '../repositories/apigatewayrepositoryv2.js';

export class ApiGatewayControllerV2 {
  private repo: ApiGatewayRepositoryV2;
  private logger: Logger;

  constructor(repo: ApiGatewayRepositoryV2, logger: Logger) {
    this.repo = repo;
    this.logger = logger;
  }
  ...
  public async getById(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in ApiGatewayControllerV2.getById:`, err);
  ...
  public async listByTenant(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in ApiGatewayControllerV2.listByTenant:`, err);
      return res.status(500).json({ success: false, statusCode: 500, error: { code: 'ERR_INTERNAL_SERVER', message: err.message } });
    }
  }
  ...
  public async create(req: Request, res: Response): Promise<Response> {
    ...
    try {
      ...
      this.logger.error(`Error in ApiGatewayControllerV2.create:`, err);
      return res.status(500).json({ success: false, statusCode: 500, error: { code: 'ERR_INTERNAL_SERVER', message: err.message } });
    }
  }
}
