...
def generate_prod_expansion_engine():
    print("Generating comprehensive Production Expansion Engine Modules...")

    # 1. Order Invoice PDF HTML Generator
    write_file("services/order-service/src/domain/invoice-pdf-template.ts", """import { OrderEntity } from '@novacommerce/core-types';
...
""")
    ...
    # 2. Payment Gateway Health Probe
    write_file("services/payment-service/src/domain/gateway-health-probe.ts", """import { Logger } from '@novacommerce/core-logger';
...
""")
    ...
    print("Production expansion engine modules generated.")

if __name__ == "__main__":
    generate_prod_expansion_engine()
