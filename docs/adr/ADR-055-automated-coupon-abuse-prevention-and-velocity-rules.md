# ADR-055: Automated Coupon Abuse Prevention and Velocity Rules
...
## Decision
We formally adopt **Automated Coupon Abuse Prevention and Velocity Rules**.
Limit promotional coupon redemptions to 1 per payment card fingerprint and 3 per physical delivery address.
