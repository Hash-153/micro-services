# ADR-006: Zero-Trust Security, Argon2id Hashing, and JWT/RBAC Policies
...
## Decision
We formally adopt **Zero-Trust Security, Argon2id Hashing, and JWT/RBAC Policies** across all platform microservices.
