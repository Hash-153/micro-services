# ADR-172: PKCE OAuth2 Flow Enforcement for Single-Page and Mobile Applications
...
## Decision
We formally adopt **PKCE OAuth2 Flow Enforcement for Single-Page and Mobile Applications**.
Require Proof Key for Code Exchange (S256) on all authorization code grant token requests.
