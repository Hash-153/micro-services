# ADR-074: Asynchronous Event Outbox Polling with Skip Locked Optimization
...
## Decision
We formally adopt **Asynchronous Event Outbox Polling with Skip Locked Optimization**.
Utilize `FOR UPDATE SKIP LOCKED` in outbox processor for lock-free parallel queue processing.
