# ADR-048: Immutable Audit Logging for GDPR and SOX Regulatory Compliance
...
## Decision
We formally adopt **Immutable Audit Logging for GDPR and SOX Regulatory Compliance**.
Ensure audit trail records cannot be updated or deleted by any application role or administrative account.
