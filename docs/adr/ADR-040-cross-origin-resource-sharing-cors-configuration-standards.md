# ADR-040: Cross-Origin Resource Sharing CORS Configuration Standards
...
## Decision
We formally adopt **Cross-Origin Resource Sharing CORS Configuration Standards**.
Restrict CORS origins to verified customer domains and eliminate wildcard credentials reflection.
