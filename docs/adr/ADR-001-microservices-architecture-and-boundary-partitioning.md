# ADR-001: Microservices Architecture and Boundary Partitioning
...
## Decision
We formally adopt **Microservices Architecture and Boundary Partitioning** across all platform microservices.
