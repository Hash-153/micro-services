# ADR-078: Client-Side SDK Error Mapping to Strong Domain Exceptions
...
## Decision
We formally adopt **Client-Side SDK Error Mapping to Strong Domain Exceptions**.
Map HTTP 4xx/5xx status codes directly to typed SDK exceptions with retry hints.
