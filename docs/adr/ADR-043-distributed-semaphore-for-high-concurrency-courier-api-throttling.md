# ADR-043: Distributed Semaphore for High-Concurrency Courier API Throttling
...
## Decision
We formally adopt **Distributed Semaphore for High-Concurrency Courier API Throttling**.
Throttle outbound carrier API requests using Redis distributed semaphores to respect carrier rate limits.
