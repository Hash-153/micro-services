# ADR-190: Automated Deadlock Detection and Connection Pool Jitter
...
## Decision
We formally adopt **Automated Deadlock Detection and Connection Pool Jitter**.
Configure HikariCP and pgBouncer with random connection acquisition jitter to break synchronization locks.
