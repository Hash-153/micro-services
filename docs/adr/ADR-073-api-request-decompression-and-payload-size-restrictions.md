# ADR-073: API Request Decompression and Payload Size Restrictions
...
## Decision
We formally adopt **API Request Decompression and Payload Size Restrictions**.
Accept gzip/brotli compressed request bodies with 10MB payload size limit.
