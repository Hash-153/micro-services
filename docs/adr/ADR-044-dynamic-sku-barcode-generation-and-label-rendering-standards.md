# ADR-044: Dynamic SKU Barcode Generation and Label Rendering Standards
...
## Decision
We formally adopt **Dynamic SKU Barcode Generation and Label Rendering Standards**.
Standardize on Code 128 and QR matrix formats for automated warehouse picking labels.
