# ADR-191: Zero-Trust Identity Forwarding via Cryptographic Token Signatures
...
## Decision
We formally adopt **Zero-Trust Identity Forwarding via Cryptographic Token Signatures**.
Verify JWT signatures using local RSA public keys across every service boundary.
