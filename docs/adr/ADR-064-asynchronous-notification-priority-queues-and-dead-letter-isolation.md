# ADR-064: Asynchronous Notification Priority Queues and Dead Letter Isolation
...
## Decision
We formally adopt **Asynchronous Notification Priority Queues and Dead Letter Isolation**.
Partition notification queues into High (MFA, Passwords), Medium (Order, Payment), and Low (Marketing).
