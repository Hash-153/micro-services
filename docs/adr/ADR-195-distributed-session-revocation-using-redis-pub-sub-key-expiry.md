# ADR-195: Distributed Session Revocation using Redis Pub/Sub Key Expiry
...
## Decision
We formally adopt **Distributed Session Revocation using Redis Pub/Sub Key Expiry**.
Broadcast security logout notifications to immediately invalidate active JWT session caches.
