# ADR-194: Event-Driven Inventory Replenishment using Wilson EOQ Formulas
...
## Decision
We formally adopt **Event-Driven Inventory Replenishment using Wilson EOQ Formulas**.
Automate warehouse stock purchase orders when stock levels hit calculated reorder points.
