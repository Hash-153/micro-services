# ADR-125: Distributed Mutex Lock Timeouts and Automatic Release
...
## Decision
We formally adopt **Distributed Mutex Lock Timeouts and Automatic Release**.
Set 15-second TTL on Redis distributed locks to prevent permanent deadlocks on container crashes.
