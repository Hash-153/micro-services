# ADR-066: Distributed Lock Coordination using Redis Redlock Algorithm
...
## Decision
We formally adopt **Distributed Lock Coordination using Redis Redlock Algorithm**.
Implement Redlock algorithm for distributed resource locking during multi-warehouse inventory rebalancing.
