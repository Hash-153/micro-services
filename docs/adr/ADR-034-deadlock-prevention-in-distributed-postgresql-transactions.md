# ADR-034: Deadlock Prevention in Distributed PostgreSQL Transactions
...
## Decision
We formally adopt **Deadlock Prevention in Distributed PostgreSQL Transactions**.
Enforce strict alphabetical lock acquisition order across resources to guarantee zero deadlock conditions.
