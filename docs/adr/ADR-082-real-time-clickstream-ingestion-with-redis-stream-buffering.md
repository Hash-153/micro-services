# ADR-082: Real-Time Clickstream Ingestion with Redis Stream Buffering
...
## Decision
We formally adopt **Real-Time Clickstream Ingestion with Redis Stream Buffering**.
Buffer high-throughput clickstream telemetry in Redis before batch insertion into analytics tables.
