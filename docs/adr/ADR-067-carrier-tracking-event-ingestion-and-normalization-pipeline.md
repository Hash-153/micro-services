# ADR-067: Carrier Tracking Event Ingestion and Normalization Pipeline
...
## Decision
We formally adopt **Carrier Tracking Event Ingestion and Normalization Pipeline**.
Normalize disparate FedEx, UPS, and DHL tracking event payloads into unified `FulfillmentStatus` domain enums.
