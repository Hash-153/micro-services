# ADR-151: Database Read Replica Connection Balancing in TypeORM/Prisma
...
## Decision
We formally adopt **Database Read Replica Connection Balancing in TypeORM/Prisma**.
Distribute read-only queries across multiple availability zone database replicas with round-robin weights.
