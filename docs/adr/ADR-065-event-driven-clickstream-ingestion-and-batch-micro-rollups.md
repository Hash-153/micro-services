# ADR-065: Event-Driven Clickstream Ingestion and Batch Micro-Rollups
...
## Decision
We formally adopt **Event-Driven Clickstream Ingestion and Batch Micro-Rollups**.
Buffer clickstream analytics events in Redis streams before flushing in 5-second micro-batches to PostgreSQL.
