# ADR-131: Dynamic Coupon Stacking Evaluation and Single-Use Fingerprinting
...
## Decision
We formally adopt **Dynamic Coupon Stacking Evaluation and Single-Use Fingerprinting**.
Verify coupon fingerprints against customer payment hashes to prevent unauthorized promo code reuse.
