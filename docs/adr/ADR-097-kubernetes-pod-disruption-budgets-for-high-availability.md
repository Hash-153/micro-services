# ADR-097: Kubernetes Pod Disruption Budgets for High Availability
...
## Decision
We formally adopt **Kubernetes Pod Disruption Budgets for High Availability**.
Enforce `minAvailable: 1` PodDisruptionBudgets across all multi-replica service deployments.
