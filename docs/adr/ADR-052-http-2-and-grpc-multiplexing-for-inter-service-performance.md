# ADR-052: HTTP/2 and gRPC Multiplexing for Inter-Service Performance
...
## Decision
We formally adopt **HTTP/2 and gRPC Multiplexing for Inter-Service Performance**.
Enforce HTTP/2 keep-alive and binary Protobuf multiplexing across internal microservice service meshes.
