# ADR-008: Double-Entry Financial Ledger for Immutable Payment Auditing
...
## Decision
We formally adopt **Double-Entry Financial Ledger for Immutable Payment Auditing** across all platform microservices.
