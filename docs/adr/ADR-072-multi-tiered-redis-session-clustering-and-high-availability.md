# ADR-072: Multi-Tiered Redis Session Clustering and High Availability
...
## Decision
We formally adopt **Multi-Tiered Redis Session Clustering and High Availability**.
Deploy 3-master 3-replica Redis Sentinel topology for zero-downtime cache failover.
