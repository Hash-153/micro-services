# ADR-081: Transactional Email Templating with Handlebars and CSS Inlining
...
## Decision
We formally adopt **Transactional Email Templating with Handlebars and CSS Inlining**.
Compile HTML email templates with inline CSS and strict XSS sanitization.
