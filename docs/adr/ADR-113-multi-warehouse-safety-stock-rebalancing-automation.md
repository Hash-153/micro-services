# ADR-113: Multi-Warehouse Safety Stock Rebalancing Automation
...
## Decision
We formally adopt **Multi-Warehouse Safety Stock Rebalancing Automation**.
Trigger automated stock transfers between regional warehouses when regional stock drops below 10-day demand.
