# ADR-142: Distributed Tracing Baggage Propagation across Message Queues
...
## Decision
We formally adopt **Distributed Tracing Baggage Propagation across Message Queues**.
Forward customer tenant IDs and region headers in OpenTelemetry baggage headers across async queues.
