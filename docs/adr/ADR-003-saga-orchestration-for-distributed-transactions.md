# ADR-003: Saga Orchestration for Distributed Transactions
...
## Decision
We formally adopt **Saga Orchestration for Distributed Transactions** across all platform microservices.
