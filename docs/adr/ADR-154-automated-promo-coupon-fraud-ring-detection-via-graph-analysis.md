# ADR-154: Automated Promo Coupon Fraud Ring Detection via Graph Analysis
...
## Decision
We formally adopt **Automated Promo Coupon Fraud Ring Detection via Graph Analysis**.
Detect synthetic account coupon fraud rings using shared payment instrument fingerprint graphs.
