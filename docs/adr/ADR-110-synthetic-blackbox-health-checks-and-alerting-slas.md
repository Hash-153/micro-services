# ADR-110: Synthetic Blackbox Health Checks and Alerting SLAs
...
## Decision
We formally adopt **Synthetic Blackbox Health Checks and Alerting SLAs**.
Run 30-second synthetic transactions across payment and order services to detect silent failure modes.
