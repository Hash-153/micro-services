# ADR-114: Real-Time Fraud Velocity Checks with Redis Sliding Windows
...
## Decision
We formally adopt **Real-Time Fraud Velocity Checks with Redis Sliding Windows**.
Block payment card attempts exceeding 3 charges within 60 seconds from the same device fingerprint.
