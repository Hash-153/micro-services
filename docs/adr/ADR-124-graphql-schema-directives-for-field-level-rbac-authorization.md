# ADR-124: GraphQL Schema Directives for Field-Level RBAC Authorization
...
## Decision
We formally adopt **GraphQL Schema Directives for Field-Level RBAC Authorization**.
Enforce `@auth(requires: [ADMIN])` directives on sensitive GraphQL schema field resolvers.
