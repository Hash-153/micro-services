# ADR-060: Container Image Minimization and Non-Root Security Profiles
...
## Decision
We formally adopt **Container Image Minimization and Non-Root Security Profiles**.
Mandate multi-stage Alpine Dockerfiles running under non-root unprivileged `node` UID 1000.
