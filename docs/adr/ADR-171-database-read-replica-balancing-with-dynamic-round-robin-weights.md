# ADR-171: Database Read Replica Balancing with Dynamic Round-Robin Weights
...
## Decision
We formally adopt **Database Read Replica Balancing with Dynamic Round-Robin Weights**.
Balance read traffic across database replicas weighted by observed CPU load and replication lag.
