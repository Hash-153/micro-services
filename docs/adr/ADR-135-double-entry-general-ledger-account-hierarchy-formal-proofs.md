# ADR-135: Double-Entry General Ledger Account Hierarchy Formal Proofs
...
## Decision
We formally adopt **Double-Entry General Ledger Account Hierarchy Formal Proofs**.
Enforce mathematical invariance $\sum \text{Debit} - \sum \text{Credit} = 0$ on every journal write.
