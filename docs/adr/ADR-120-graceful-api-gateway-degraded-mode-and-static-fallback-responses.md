# ADR-120: Graceful API Gateway Degraded Mode and Static Fallback Responses
...
## Decision
We formally adopt **Graceful API Gateway Degraded Mode and Static Fallback Responses**.
Serve cached catalog snapshots when backend catalog service experiences transient downstream degradation.
