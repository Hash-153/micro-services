# ADR-099: Comprehensive Automated Smoke Testing Suite for Production Releases
...
## Decision
We formally adopt **Comprehensive Automated Smoke Testing Suite for Production Releases**.
Execute end-to-end synthetic checkout smoke tests immediately following blue/green traffic switch.
