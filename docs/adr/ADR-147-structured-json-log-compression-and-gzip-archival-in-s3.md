# ADR-147: Structured JSON Log Compression and Gzip Archival in S3
...
## Decision
We formally adopt **Structured JSON Log Compression and Gzip Archival in S3**.
Compress rotated container logs with gzip and stream to immutable compliance S3 buckets.
