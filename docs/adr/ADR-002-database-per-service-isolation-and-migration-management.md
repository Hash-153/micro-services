# ADR-002: Database-per-Service Isolation and Migration Management
...
## Decision
We formally adopt **Database-per-Service Isolation and Migration Management** across all platform microservices.
