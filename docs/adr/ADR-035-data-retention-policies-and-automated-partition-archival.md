# ADR-035: Data Retention Policies and Automated Partition Archival
...
## Decision
We formally adopt **Data Retention Policies and Automated Partition Archival**.
Implement monthly PostgreSQL table partitioning on `analytics_events` and `audit_logs` with 1-year retention.
