# ADR-175: Asynchronous Delivery Receipt Milestone Ingestion Deduplication
...
## Decision
We formally adopt **Asynchronous Delivery Receipt Milestone Ingestion Deduplication**.
Deduplicate tracking status webhooks using carrier milestone timestamps and tracking numbers.
