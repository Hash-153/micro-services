# ADR-033: Client-Side SDK Retry with Exponential Backoff and Full Jitter
...
## Decision
We formally adopt **Client-Side SDK Retry with Exponential Backoff and Full Jitter**.
Standardize client SDK retry algorithms using Decorrelated Jitter to prevent thundering herd spikes.
