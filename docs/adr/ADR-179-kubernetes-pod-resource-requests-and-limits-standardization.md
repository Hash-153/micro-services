# ADR-179: Kubernetes Pod Resource Requests and Limits Standardization
...
## Decision
We formally adopt **Kubernetes Pod Resource Requests and Limits Standardization**.
Standardize resource requests at 250m CPU / 512Mi RAM and limits at 1000m CPU / 1Gi RAM per microservice pod.
