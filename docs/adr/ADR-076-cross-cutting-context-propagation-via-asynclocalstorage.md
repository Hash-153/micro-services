# ADR-076: Cross-Cutting Context Propagation via AsyncLocalStorage
...
## Decision
We formally adopt **Cross-Cutting Context Propagation via AsyncLocalStorage**.
Use Node.js `AsyncLocalStorage` to propagate correlation IDs across asynchronous callback chains.
