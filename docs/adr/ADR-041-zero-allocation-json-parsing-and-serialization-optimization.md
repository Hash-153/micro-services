# ADR-041: Zero-Allocation JSON Parsing and Serialization Optimization
...
## Decision
We formally adopt **Zero-Allocation JSON Parsing and Serialization Optimization**.
Utilize streaming JSON parsers for payload ingestion exceeding 1MB in analytics service.
