# ADR-104: High-Throughput Order Ingestion Separation via CQRS Read Models
...
## Decision
We formally adopt **High-Throughput Order Ingestion Separation via CQRS Read Models**.
Decouple order writes to primary database from customer order history read queries via asynchronous view projections.
