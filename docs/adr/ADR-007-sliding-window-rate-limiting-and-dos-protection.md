# ADR-007: Sliding-Window Rate Limiting and DoS Protection
...
## Decision
We formally adopt **Sliding-Window Rate Limiting and DoS Protection** across all platform microservices.
