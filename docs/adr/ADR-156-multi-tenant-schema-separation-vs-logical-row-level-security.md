# ADR-156: Multi-Tenant Schema Separation vs Logical Row-Level Security
...
## Decision
We formally adopt **Multi-Tenant Schema Separation vs Logical Row-Level Security**.
Enforce logical row-level tenant separation with mandatory PostgreSQL row security policies.
