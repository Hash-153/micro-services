# ADR-101: Edge Computing and CDN Static Asset Optimization
...
## Decision
We formally adopt **Edge Computing and CDN Static Asset Optimization**.
Deploy Cloudflare edge caching for product images and static catalog assets with 30-day immutable caching headers.
