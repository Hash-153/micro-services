# ADR-139: Automated Database Vacuuming and Autovacuum Tuning for PostgreSQL
...
## Decision
We formally adopt **Automated Database Vacuuming and Autovacuum Tuning for PostgreSQL**.
Tune `autovacuum_vacuum_scale_factor = 0.05` and `autovacuum_cost_limit = 2000` on orders database.
