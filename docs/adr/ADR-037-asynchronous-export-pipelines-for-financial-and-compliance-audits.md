# ADR-037: Asynchronous Export Pipelines for Financial and Compliance Audits
...
## Decision
We formally adopt **Asynchronous Export Pipelines for Financial and Compliance Audits**.
Execute large reporting queries asynchronously with CSV generation offloaded to background worker daemons.
