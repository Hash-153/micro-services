# ADR-122: Automated Session Invalidation on Privilege Role Mutation
...
## Decision
We formally adopt **Automated Session Invalidation on Privilege Role Mutation**.
Terminate active user JWT sessions immediately when an administrative role downgrade occurs.
