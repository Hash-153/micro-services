# ADR-132: High-Throughput Order Ingestion Separation via Event-Driven Outbox
...
## Decision
We formally adopt **High-Throughput Order Ingestion Separation via Event-Driven Outbox**.
Persist orders and outbox event records in single PostgreSQL local transactions to ensure atomic delivery.
