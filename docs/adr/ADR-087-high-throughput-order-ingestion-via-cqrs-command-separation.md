# ADR-087: High-Throughput Order Ingestion via CQRS Command Separation
...
## Decision
We formally adopt **High-Throughput Order Ingestion via CQRS Command Separation**.
Separate order placement write path from order history read queries to maximize scalability.
