# ADR-103: Microservice Database Connection Pooling Strategy with Hikari and pgBouncer
...
## Decision
We formally adopt **Microservice Database Connection Pooling Strategy with Hikari and pgBouncer**.
Establish maximum pool size of 15 connections per container with 30-second idle timeout.
