# ADR-166: Distributed Lock Coordination using Redis Redlock Mutex Protocol
...
## Decision
We formally adopt **Distributed Lock Coordination using Redis Redlock Mutex Protocol**.
Implement Redlock distributed mutex locks during multi-warehouse inventory balance adjustments.
