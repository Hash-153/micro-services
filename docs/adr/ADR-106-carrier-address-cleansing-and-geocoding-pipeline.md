# ADR-106: Carrier Address Cleansing and Geocoding Pipeline
...
## Decision
We formally adopt **Carrier Address Cleansing and Geocoding Pipeline**.
Integrate automated address normalization to eliminate failed carrier delivery attempts and returned packages.
