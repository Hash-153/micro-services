# ADR-123: Microservice Database Connection Pool Starvation Alarms
...
## Decision
We formally adopt **Microservice Database Connection Pool Starvation Alarms**.
Trigger Prometheus high-priority alerts when connection pool utilization exceeds 85% for 60 seconds.
