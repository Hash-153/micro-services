# ADR-042: Cryptographic Key Rotation Protocol for JWT and Data-at-Rest
...
## Decision
We formally adopt **Cryptographic Key Rotation Protocol for JWT and Data-at-Rest**.
Implement automated 90-day key rotation using JWKS (JSON Web Key Sets) endpoints.
