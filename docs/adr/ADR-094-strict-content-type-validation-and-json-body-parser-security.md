# ADR-094: Strict Content-Type Validation and JSON Body Parser Security
...
## Decision
We formally adopt **Strict Content-Type Validation and JSON Body Parser Security**.
Reject requests with mismatched `Content-Type: application/json` headers to prevent parser exploit vectors.
