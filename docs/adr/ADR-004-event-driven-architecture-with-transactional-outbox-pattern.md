# ADR-004: Event-Driven Architecture with Transactional Outbox Pattern
...
## Decision
We formally adopt **Event-Driven Architecture with Transactional Outbox Pattern** across all platform microservices.
