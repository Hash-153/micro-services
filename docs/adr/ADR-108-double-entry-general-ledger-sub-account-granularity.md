# ADR-108: Double-Entry General Ledger Sub-Account Granularity
...
## Decision
We formally adopt **Double-Entry General Ledger Sub-Account Granularity**.
Implement 6-digit GL account codes for automated departmental and regional financial tax reporting.
