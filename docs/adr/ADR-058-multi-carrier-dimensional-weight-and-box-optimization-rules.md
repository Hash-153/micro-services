# ADR-058: Multi-Carrier Dimensional Weight and Box Optimization Rules
...
## Decision
We formally adopt **Multi-Carrier Dimensional Weight and Box Optimization Rules**.
Standardize dimensional weight calculation divisor on 5000 (IATA metric standard) across all parcel shipments.
