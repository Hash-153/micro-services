# ADR-086: Cryptographic Nonce and Timestamp Verification for Webhooks
...
## Decision
We formally adopt **Cryptographic Nonce and Timestamp Verification for Webhooks**.
Require incoming provider webhooks to include valid signed timestamps within 5-minute tolerance.
