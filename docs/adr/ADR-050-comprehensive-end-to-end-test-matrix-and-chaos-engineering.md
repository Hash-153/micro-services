# ADR-050: Comprehensive End-to-End Test Matrix and Chaos Engineering
...
## Decision
We formally adopt **Comprehensive End-to-End Test Matrix and Chaos Engineering**.
Execute chaos network latency injection tests to verify saga rollback compensation resilience under network partitions.
