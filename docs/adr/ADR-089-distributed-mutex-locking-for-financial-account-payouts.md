# ADR-089: Distributed Mutex Locking for Financial Account Payouts
...
## Decision
We formally adopt **Distributed Mutex Locking for Financial Account Payouts**.
Acquire distributed Redis mutex locks when settling balances to prevent concurrent race conditions.
