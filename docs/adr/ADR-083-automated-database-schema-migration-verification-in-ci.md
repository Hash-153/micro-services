# ADR-083: Automated Database Schema Migration Verification in CI
...
## Decision
We formally adopt **Automated Database Schema Migration Verification in CI**.
Execute forward and rollback schema migrations against transient PostgreSQL test containers in GitHub Actions.
