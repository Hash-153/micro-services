# ADR-118: Dynamic Product Recommendation Engine and Collaborative Filtering
...
## Decision
We formally adopt **Dynamic Product Recommendation Engine and Collaborative Filtering**.
Generate personalized product recommendations using offline ALS matrix factorization models.
