# ADR-117: Asynchronous Delivery Receipt Ingestion from Courier Webhooks
...
## Decision
We formally adopt **Asynchronous Delivery Receipt Ingestion from Courier Webhooks**.
Process FedEx and UPS delivery confirmation webhooks via durable queue ingestion with at-least-once delivery.
