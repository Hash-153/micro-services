# ADR-092: Dynamic Product Category Taxonomy and Breadcrumb Resolution
...
## Decision
We formally adopt **Dynamic Product Category Taxonomy and Breadcrumb Resolution**.
Resolve recursive category hierarchies in memory with cached closure tables.
