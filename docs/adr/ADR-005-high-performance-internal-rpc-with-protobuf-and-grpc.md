# ADR-005: High-Performance Internal RPC with Protobuf and gRPC
...
## Decision
We formally adopt **High-Performance Internal RPC with Protobuf and gRPC** across all platform microservices.
