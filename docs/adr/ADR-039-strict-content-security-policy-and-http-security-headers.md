# ADR-039: Strict Content Security Policy and HTTP Security Headers
...
## Decision
We formally adopt **Strict Content Security Policy and HTTP Security Headers**.
Enforce HSTS, CSP, X-Content-Type-Options, and X-Frame-Options across all API Gateway responses.
