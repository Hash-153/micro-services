# ADR-057: Double-Entry General Ledger Account Hierarchies and Sub-Ledgers
...
## Decision
We formally adopt **Double-Entry General Ledger Account Hierarchies and Sub-Ledgers**.
Implement 5-digit sub-account ledger hierarchy for granular departmental cost-center attribution.
