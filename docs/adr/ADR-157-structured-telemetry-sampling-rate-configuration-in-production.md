# ADR-157: Structured Telemetry Sampling Rate Configuration in Production
...
## Decision
We formally adopt **Structured Telemetry Sampling Rate Configuration in Production**.
Sample 100% of errors and slow requests (>200ms) while sampling 10% of high-volume healthy 200 OK traffic.
