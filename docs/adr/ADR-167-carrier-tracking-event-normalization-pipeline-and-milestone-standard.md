# ADR-167: Carrier Tracking Event Normalization Pipeline and Milestone Standard
...
## Decision
We formally adopt **Carrier Tracking Event Normalization Pipeline and Milestone Standard**.
Normalize FedEx, UPS, and DHL tracking event payloads into unified `FulfillmentStatus` domain enums.
