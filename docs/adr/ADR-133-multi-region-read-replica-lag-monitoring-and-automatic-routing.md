# ADR-133: Multi-Region Read Replica Lag Monitoring and Automatic Routing
...
## Decision
We formally adopt **Multi-Region Read Replica Lag Monitoring and Automatic Routing**.
Bypass stale read replicas if replication lag exceeds 500ms and route reads to primary leader.
