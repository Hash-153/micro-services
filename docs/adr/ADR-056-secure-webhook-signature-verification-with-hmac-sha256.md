# ADR-056: Secure Webhook Signature Verification with HMAC-SHA256
...
## Decision
We formally adopt **Secure Webhook Signature Verification with HMAC-SHA256**.
Sign outbound customer webhooks with HMAC-SHA256 signatures in `X-NovaCommerce-Signature` header.
