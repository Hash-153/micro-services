# ADR-158: API Gateway Ingress Request Sanitization and Header Whitelisting
...
## Decision
We formally adopt **API Gateway Ingress Request Sanitization and Header Whitelisting**.
Strip untrusted internal headers (`x-internal-user-id`, `x-admin-override`) from edge ingress traffic.
