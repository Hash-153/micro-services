# ADR-196: Multi-Carrier Dimensional Weight Optimization using 3D Bin Packing
...
## Decision
We formally adopt **Multi-Carrier Dimensional Weight Optimization using 3D Bin Packing**.
Pack customer items into smallest volumetric box to reduce carrier freight costs.
