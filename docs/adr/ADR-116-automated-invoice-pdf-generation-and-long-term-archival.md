# ADR-116: Automated Invoice PDF Generation and Long-Term Archival
...
## Decision
We formally adopt **Automated Invoice PDF Generation and Long-Term Archival**.
Offload invoice PDF rendering to background worker pods and archive generated assets in S3 Glacier.
