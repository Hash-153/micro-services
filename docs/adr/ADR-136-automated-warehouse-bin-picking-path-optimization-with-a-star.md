# ADR-136: Automated Warehouse Bin Picking Path Optimization with A-Star
...
## Decision
We formally adopt **Automated Warehouse Bin Picking Path Optimization with A-Star**.
Compute shortest warehouse picking trajectories using A* pathfinding across aisle graph nodes.
