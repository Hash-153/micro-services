# ADR-192: Dynamic Rate Limit Burst Allocation for Priority Enterprise Tenants
...
## Decision
We formally adopt **Dynamic Rate Limit Burst Allocation for Priority Enterprise Tenants**.
Provide dedicated 10,000 req/min rate limit allocations for enterprise B2B partner API keys.
