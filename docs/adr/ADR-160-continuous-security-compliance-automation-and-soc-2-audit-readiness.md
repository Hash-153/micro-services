# ADR-160: Continuous Security Compliance Automation and SOC-2 Audit Readiness
...
## Decision
We formally adopt **Continuous Security Compliance Automation and SOC-2 Audit Readiness**.
Generate continuous automated compliance evidence artifacts using open-source compliance pipelines.
