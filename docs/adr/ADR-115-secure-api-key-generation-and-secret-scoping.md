# ADR-115: Secure API Key Generation and Secret Scoping
...
## Decision
We formally adopt **Secure API Key Generation and Secret Scoping**.
Generate cryptographically secure 64-character API keys with granular RBAC scopes for partner integrations.
