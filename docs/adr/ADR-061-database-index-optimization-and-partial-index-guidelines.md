# ADR-061: Database Index Optimization and Partial Index Guidelines
...
## Decision
We formally adopt **Database Index Optimization and Partial Index Guidelines**.
Utilize partial indexes for soft-deleted entities (`WHERE deleted_at IS NULL`) to reduce index tree size.
