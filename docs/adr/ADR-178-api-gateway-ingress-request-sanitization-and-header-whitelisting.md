# ADR-178: API Gateway Ingress Request Sanitization and Header Whitelisting
...
Strip untrusted internal headers from edge ingress traffic before routing to microservices.
