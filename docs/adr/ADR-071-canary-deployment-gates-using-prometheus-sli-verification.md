# ADR-071: Canary Deployment Gates using Prometheus SLI Verification
...
## Decision
We formally adopt **Canary Deployment Gates using Prometheus SLI Verification**.
Automate traffic shifting in 10% steps while evaluating 5xx error budget and latency SLOs.
