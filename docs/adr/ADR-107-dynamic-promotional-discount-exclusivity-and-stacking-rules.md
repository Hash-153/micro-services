# ADR-107: Dynamic Promotional Discount Exclusivity and Stacking Rules
...
## Decision
We formally adopt **Dynamic Promotional Discount Exclusivity and Stacking Rules**.
Enforce coupon hierarchy rules preventing unauthorized stacking of percentage discounts with wholesale prices.
