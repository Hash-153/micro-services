# ADR-070: Synthetic Blackbox Probing and Error Budget Policy
...
## Decision
We formally adopt **Synthetic Blackbox Probing and Error Budget Policy**.
Automate rollback of production deployments if synthetic probe availability drops below 99.95% over 10 minutes.
