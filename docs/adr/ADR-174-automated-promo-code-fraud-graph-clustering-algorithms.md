# ADR-174: Automated Promo Code Fraud Graph Clustering Algorithms
...
## Decision
We formally adopt **Automated Promo Code Fraud Graph Clustering Algorithms**.
Detect coordinated promotion abuse rings by clustering IP subnets, device IDs, and payment fingerprints.
