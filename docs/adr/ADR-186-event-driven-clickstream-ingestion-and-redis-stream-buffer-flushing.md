# ADR-186: Event-Driven Clickstream Ingestion and Redis Stream Buffer Flushing
...
## Decision
We formally adopt **Event-Driven Clickstream Ingestion and Redis Stream Buffer Flushing**.
Buffer clickstream telemetry in Redis streams before flushing in 5-second micro-batches to PostgreSQL.
