# ADR-153: Dynamic Warehouse Bin Allocation Traversal via Nearest Neighbor
...
## Decision
We formally adopt **Dynamic Warehouse Bin Allocation Traversal via Nearest Neighbor**.
Group warehouse picking routes by aisle clusters to minimize picker travel distance by 35%.
